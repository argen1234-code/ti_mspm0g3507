...
void *g_pMC_App  = (void*)(APP_USER_STATUS_BASE + sizeof(USER_STATUS_INTERFACE_T)+ sizeof(UART_Instance)+ sizeof(HV_DIE_EEPROM_INTERFACE_T)+ sizeof(APP_INTERFACE_T));
...
static void setUserDefaultMotorParameters(void)
{
    ...
    pUserCtrlRegs->dacCtrl.dacOutAddr = 0x202005D8;
