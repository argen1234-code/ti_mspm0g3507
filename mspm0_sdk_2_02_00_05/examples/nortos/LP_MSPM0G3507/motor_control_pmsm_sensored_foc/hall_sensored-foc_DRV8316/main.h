...
/*! @brief Sensored FOC Application Definition */
#define SENSORED_FOC
...
#define APP_SHADOW_END             0x20200FFCUL
...
#elif defined TIDA010950

/*! @brief TIDA010950 has inverting isense */
#define _INVERT_ISEN
/*! @brief TIDA010950 propagation delay */
#define DRIVER_PROPAGATION_DELAY_nS                100
/*! @brief TIDA010950 minimum on time (rise time + settling time) */
#define DRIVER_MIN_ON_TIME_nS                      1000
/*! @brief DC voltage base value */
#define DC_VOLTAGE_BASE                             30.57
/*! @brief Full scale readable current used as current base value,
calculated using (FULL Scale Voltage(3.3)/2* CSA Gain(0.15(v/A))) */
#define FULL_SCALE_CURRENT_BASE                     11
/*! @brief Current shunt configuration */
...
#elif defined TIDA010251

/*! @brief TIDA010251 has non inverting isense */
#define _NONINVERT_ISEN
/*! @brief TIDA010251 propagation delay */
#define DRIVER_PROPAGATION_DELAY_nS                100
/*! @brief TIDA010251 minimum on time (rise time + settling time) */
#define DRIVER_MIN_ON_TIME_nS                      2000
/*! @brief DC voltage base value */
#define DC_VOLTAGE_BASE                             36.3
/*! @brief Full scale readable current used as current base value,
calculated using (FULL Scale Voltage(3.3)/2* CSA Gain) */
#define FULL_SCALE_CURRENT_BASE                     20.625
/*! @brief Current shunt configuration */
#define __CURRENT_SINGLE_SHUNT
/*! @brief Enable dynamic current shunt changing */
#define DYNAMIC_CURRENT_SHUNT_CONFIG_EN             FALSE
...
/*! @brief Abnormal Hall Index fault index */
