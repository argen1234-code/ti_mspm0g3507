...
const uint32_t forwardHallIndexLUT[MAX_HALL_INDEX] = {_IQ(0), _IQ(0.2818) , _IQ(0.5543),
                                                      _IQ(0.4168) , _IQ(0.9255) , _IQ(0.0509),
                                                      _IQ(0.7703)};

const uint32_t reverseHallIndexLUT[MAX_HALL_INDEX] = {_IQ(0), _IQ(0.4139) , _IQ(0.752),
                                                      _IQ(0.5802) , _IQ(0.07644) , _IQ(0.25839),
                                                      _IQ(0.9181)};
